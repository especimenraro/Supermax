            ...
            <tbody>
                <tr>
                    ...
                    foreach ( $terms as $term ) {
                        echo '<td class="br_product_hidden_'.esc_html($term['id']).'">
                            <h3><a href="'.esc_url($term['link']).'">'.esc_html($term['title']).'</a></h3>';
                        ...
                        echo '<a href="#remove" class="br_remove_compare_product_reload" data-id="'.esc_html($default_product).'"><i class="fa fa-times"></i></a>';
                        echo '</td>';
                    }
                    ?>
                </tr>
        ...
        <table>
            <tbody>
                <tr class="br_stock_br_top_first_block">
                    ...
                    <?php
                    foreach ( $terms as $term ) {
                        echo '<td class="br_product_'.esc_html($term['id']).'">';

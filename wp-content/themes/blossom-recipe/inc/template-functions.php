...
add_action( 'blossom_recipe_before_header', 'blossom_recipe_header_search', 10 );
...
function blossom_recipe_entry_header(){ ?>
    <header class="entry-header">
		<?php 
            ...
            if( is_single() ){
                if( ! $ed_cat_single ) blossom_recipe_category();
            }else{
            ...
            if( 'post' === get_post_type() || ( blossom_recipe_is_brm_activated() && 'blossom-recipe' === get_post_type() ) ){
                ...
                if( is_single() ){
                    if( ! $ed_post_author ) blossom_recipe_posted_by();
                    if( ! $ed_post_date ) blossom_recipe_posted_on();
                }else{
    ...
    <div class="bottom-footer">
		<div class="container">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/themes/blossom-recipe-free-wordpress-theme' ) .'" rel="author" target="_blank">' . esc_html__( ' Blossom Recipe', 'blossom-recipe' ) . '</a>' . esc_html__( ' by Blossom Themes.', 'blossom-recipe' );

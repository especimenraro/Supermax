...
<div id="plugins-panel" class="panel-left visible">
	...
	<p><?php _e( 'Below is a list of recommended plugins to install that will help you get the most out of Blossom Recipe. Although each plugin is optional, it is recommended that you at least install the Blossom Recipe Maker, BlossomThemes Toolkit, BlossomThemes Email Newsletter & BlossomThemes Instagram Feed to create a website similar to the Blossom Recipe demo.', 'blossom-recipe' ); ?></p>
